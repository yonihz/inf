...
void TestBasic()
{
	...
	/* TODO:
	check free works and change size
	check no more free ips: loop that checks status is success in all iterations
	and one more check after loop that checks status is no_more_ips
	*/
